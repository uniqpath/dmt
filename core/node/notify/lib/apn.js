...
import { log, dateFns, accessTokensDir, deviceGeneralIdentifier, colors, isRPi, isLanServer, program, apMode } from 'dmt/common';
...
function notify(msg, { users = null, originDevice = undefined } = {}) {
  return new Promise((success, reject) => {
    if (apMode()) {
      log.cyan('Not sending apn message in access point (AP) mode:');
      log.gray(msg);
      success();
      return;
    }
