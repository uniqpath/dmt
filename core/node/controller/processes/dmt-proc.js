...
import exceptionNotify from '../program/errors/exceptionNotify.js';
import getExitMsg from '../program/errors/getExitMsg.js';
...
try {
  ...
  exceptionNotify(getExitMsg(e), { exitProcess: true });
}
