...
const headers = ['device', 'IP address', 'dmt version', 'node.js', 'platform', 'os uptime', 'dmt uptime', 'user', 'wifi', '🔗'];
      ...
      table.push(
        ...nearbyDevices.map(device => {
          ...
          return [
            ...
            connectivityFailures12h > 1 ? colors.red(connectivityFailures12h || '') : colors.gray(connectivityFailures12h || '')
          ];
        })
      );
