describe('tableLayout', function() {
  ...
  it('complex layout', function() {
    var actual = makeTableLayout([[{ content: 'hello', rowSpan: 2, colSpan: 2 }, { content: 'yo', rowSpan: 2, colSpan: 2 }, 'goodbye'], ['adios']]);
  ...
  it('complex layout2', function() {
    var actual = makeTableLayout([['a', 'b', { content: 'c', rowSpan: 3, colSpan: 2 }, 'd'], [{ content: 'e', rowSpan: 2, colSpan: 2 }, 'f'], ['g']]);
  ...
  function checkExpectation(actualCell, expectedCell, x, y, actualTable) {
    ...
    if (expectedCell.hasOwnProperty('spannerFor')) {
      ...
      expect(actualCell.originalCell, address + 'originalCell not right').to.equal(
