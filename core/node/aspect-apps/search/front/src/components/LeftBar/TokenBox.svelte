...
<div class="promo">
  ...
  <div class="inner">
      ...
      <img class="icon" src="/apps/search/img/zeta_symbol.png">
  ...
  <!-- <p class="invite">
    ...
    {#if metamaskConnect}
      <a href="#" on:click|preventDefault={() => { login(); }}>
        Login with <img src="/apps/search/img/metamask.png" alt="metamask " /> MetaMask
      </a>
    {:else}
      <a href="https://metamask.io">Install <img src="/apps/search/img/metamask.png"alt="metamask " />
        MetaMask
      </a>
    {/if}
