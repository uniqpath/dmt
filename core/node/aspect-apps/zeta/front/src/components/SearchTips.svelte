...
<!-- {#if isZetaSeek}
      <div class="search_suggestions">
        ...
        <a href="#" on:click|preventDefault={() => placeSearch('Eth Scaling')}>Eth Scaling</a> <span>·</span>
        <a href="#" on:click|preventDefault={() => placeSearch('Zeta -TXT', ['58743c44ae8ac8076c3c4aac4bdd5052124657c6852fdcceb80488bbbd340920', '86ff50b0a7d17bc7190242d1f94b464d0e69b31e76a2d6694e374a39e7ebba1d'])}>Zeta <img class="zeta_title" src="/apps/zeta/img/experiment.png"></a>
      </div>
    {/if} -->
