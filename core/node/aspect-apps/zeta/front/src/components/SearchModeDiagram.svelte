...
{#if diagramIsVisible}
  <div class="diagram">
    ...
    {#if $searchMode == 0}
      <img src="/apps/zeta/img/zeta_search_queries0.png" alt="zeta_search_query_public" />
    {:else}
      <img src="/apps/zeta/img/zeta_search_queries1.png" alt="zeta_search_query_this_node" />
    {/if}
  </div>
{/if}
