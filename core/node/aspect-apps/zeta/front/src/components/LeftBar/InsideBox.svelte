...
<div class="promo" bind:this={promoBox} class:visible={!minimized}>
  ...
  {#if teamName == 'Swarm'}
    ...
    <div class="inner">
      ...
      <section class:visible={sections.Swarm.visible}>
        Get <a href="#" on:click|preventDefault={() => { app.emit('search', 'Book of Swarm pdf'); }}>The Book Of Swarm</a> 📙🐝
        <!-- The Book Of Swarm → <a class="outside" href="https://swarm-gateways.net/bzz:/35810ba9634c3b3978edfd79961dfda2f5a79ec46c3b3c0c8d209c5217318ac5/">download from Swarm p2p network</a> itself. -->
      ...
      <p>
        <a class="outside" href="https://swarm.ethereum.org">Swarm Project Website</a>
        <!-- or via <a href="https://swarm-gateways.net/bzz:/swarm.eth/" class="outside">Swarm gateway</a> -->
        <br>
    ...
    {:else if teamName == 'Filecoin'}

      <h3><span class="filecoin_official">{teamName.toUpperCase()}</span> 😎🏖️ </h3>
