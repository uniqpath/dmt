...
module.exports = function(runTest) {
  ...
  it('use rowSpan to span rows - (rowSpan on the left side)', function() {
    function makeTable() {
      ...
      table.push([{ rowSpan: 2, content: 'greetings' }, { rowSpan: 2, content: 'greetings', vAlign: 'center' }, 'hello'], ['howdy']);
  ...
  it('use rowSpan to span rows - (rowSpan on the right side)', function() {
    function makeTable() {
      ...
      table.push(['hello', { rowSpan: 2, content: 'greetings' }, { rowSpan: 2, content: 'greetings', vAlign: 'bottom' }], ['howdy']);
  ...
  it('multi-line content will flow across rows in rowSpan cells', function() {
    function makeTable() {
      ...
      table.push(['hello', { rowSpan: 2, content: 'greetings\nfriends' }, { rowSpan: 2, content: 'greetings\nfriends' }], ['howdy']);
