...
- `notifyDayBeforeAt` — specify at what time one day before the event there will be an announcement pre-notification
- `notifyMinutesBefore` — a lot of times we want to be notified one or more hours before the event
...
const list = [
  ...
  { title: 'Party', when: ['2022/12/31 20:00'], symbol: '🥳' }
];
