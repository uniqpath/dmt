...
if you have a bit older Debian Kernel, you can re-do the droplet and keep the ip address...
On Digital Ocean go to Destroy and Rebuild, choose latest Debian Kernel...
If you have new enough Kernel you can upgrade the Kernel without rebuilding.. on Digital Ocean or from the Kernel itself.

❗ make sure to backup anything important, possibly ~/.dmt-here if you saved anything there programatically.
